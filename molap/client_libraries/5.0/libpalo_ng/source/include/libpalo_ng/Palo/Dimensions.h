...
public:
	 ...
	 */
	explicit Dimensions(boost::shared_ptr<ServerImpl> serverImpl, boost::shared_ptr<PaloClient> paloClient, unsigned int database);
	 ...
	 */
	Dimension operator[](unsigned int id);
