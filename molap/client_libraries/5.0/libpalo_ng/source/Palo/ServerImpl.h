...
public:
	...
	boost::shared_ptr<const SIDatabases> getDatabases(boost::shared_ptr<PaloClient> paloClient, bool update);
	...
	boost::shared_ptr<const SICubes> getCubes(boost::shared_ptr<PaloClient> paloClient, unsigned int db, bool update);
	...
	boost::shared_ptr<const SIDimensions> getDimensions(boost::shared_ptr<PaloClient> paloClient, unsigned int db, bool update);
	...
	boost::shared_ptr<const SIElements> getElements(boost::shared_ptr<PaloClient> paloClient, unsigned int db, unsigned int dim, bool update);
