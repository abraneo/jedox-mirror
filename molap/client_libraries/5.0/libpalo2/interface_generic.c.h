...
LIBEXPORT palo_err LIBPALO_FUNC_R(_getdata_multi)(struct errstack *errs, struct arg_palo_value_array *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_2d *coordinates) {
	...
	pe = PALO_SUFFIX(_getdata_multi)(errs, result, so, convs, database, cube, coordinates);
...
LIBEXPORT palo_err LIBPALO_FUNC_R(_setdata_multi)(struct errstack *errs, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_palo_dataset_array *dsa, splash_mode mode, unsigned short add, unsigned short eventprocessor) {
	palo_err pe;

	pe = PALO_SUFFIX(_setdata_multi)(errs, so, convs, database, cube, dsa, mode, add, eventprocessor);
	if (pe != PALO_SUCCESS) {
		ERRSTACK_RETURN(errs, pe, __FUNCTION__, __LINE__, __FILE__, NULL);
	}
...
LIBEXPORT libpalo_result LIBPALO_FUNC_R(getdata_multi)(libpalo_err *err, struct arg_palo_value_array *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_2d coordinates) {
	...
	return _to_libpalo_result(LIBPALO_FUNC_R(_getdata_multi)(errs, result, so, convs, database, cube, &coordinates), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
...
LIBEXPORT libpalo_result LIBPALO_FUNC_R(setdata_multi)(libpalo_err *err, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_palo_dataset_array dsa, splash_mode mode, unsigned short add, unsigned short eventprocessor) {
	...
	return _to_libpalo_result(LIBPALO_FUNC_R(_setdata_multi)(errs, so, convs, database, cube, &dsa, mode, add, eventprocessor), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
...
/** @brief
 *  deprecated use dimension_list_elements2_raw instead
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(dimension_list_elements2)(libpalo_err *err, struct arg_dim_element_info2_array *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *dimension) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(dimension_list_elements2)(errs, result, so, convs, database, dimension), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *  @param database name of the database
 *  @param cube name of the cube
 *  @param elements array of string arrays containing the elements whose values should be exported
 *  @param options options
 *
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(getdata_export)(libpalo_err *err, struct arg_getdata_export_result *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_array elements, struct arg_getdata_export_options options) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(getdata_export)(errs, result, so, convs, database, cube, &elements, &options), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(getdata_export_rule)(libpalo_err *err, struct arg_getdata_export_result *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_array elements, struct arg_getdata_export_options options, unsigned short use_rules) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(getdata_export_rule)(errs, result, so, convs, database, cube, &elements, &options, use_rules), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *
 *  @param err will contain error information if the function fails; it should be free'd using libpalo_err_free_contents()
 *  @param result will contain the information; use free_dim_elemet_info2_contents() to free it
 *  @param so reference to a struct sock_obj initialized by a preceding call to palo_connect
 *  @param convs reference to a struct conversions initialized by a preceding call to libpalo_init_r()
 *
 *  @param database name of the database
 ...
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(element_info)(libpalo_err *err, struct arg_dim_element_info2 *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *dimension, const CHAR_T *element) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(element_info)(errs, result, so, convs, database, dimension, element), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(rule_add)(libpalo_err *err, struct arg_rule_info *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const CHAR_T *definition, unsigned short use_identifier, const CHAR_T *extern_id, const CHAR_T *comment, unsigned short activate) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(rule_add)(errs, result, so, convs, database, cube, definition, use_identifier, extern_id, comment, activate), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(rule_modify)(libpalo_err *err, struct arg_rule_info *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, long id, const CHAR_T *definition, unsigned short use_identifier, const CHAR_T *extern_id, const CHAR_T *comment, unsigned short activate) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(rule_modify)(errs, result, so, convs, database, cube, id, definition, use_identifier, extern_id, comment, activate), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
 ...
 *  @return check whether execution was successful using the macro LIBPALO_SUCCESSFUL(libpalo_result)
 */
LIBEXPORT libpalo_result LIBPALO_FUNC_R(cube_lock)(libpalo_err *err, struct arg_lock_info *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube,  const struct arg_str_array_array coordinates) {
	ERRSTACK_DEFINE()

	return _to_libpalo_result(PALO_SUFFIX(cube_lock)(errs, result, so, convs, database, cube,  &coordinates), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
...
/** @brief deprecated, use  imension_list_elements2_raw instead */
LIBEXPORT libpalo_result LIBPALO_FUNC(dimension_list_elements2)(libpalo_err *err, struct arg_dim_element_info2_array *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *dimension) {
	return LIBPALO_FUNC_R(dimension_list_elements2)(err, result, so, &libpalo_convs, database, dimension);
}
...
LIBEXPORT libpalo_result LIBPALO_FUNC(getdata_export)(libpalo_err *err, struct arg_getdata_export_result *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_array elements, struct arg_getdata_export_options options) {
	return LIBPALO_FUNC_R(getdata_export)(err, result, so, &libpalo_convs, database, cube, elements, options);
}


/** @brief see thread-safe getdata_export_rule() */
LIBEXPORT libpalo_result LIBPALO_FUNC(getdata_export_rule)(libpalo_err *err, struct arg_getdata_export_result *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_array elements, struct arg_getdata_export_options options, unsigned short use_rules) {
	return LIBPALO_FUNC_R(getdata_export_rule)(err, result, so, &libpalo_convs, database, cube, elements, options, use_rules);
}
...
/** @brief see thread-safe element_info() */
LIBEXPORT libpalo_result LIBPALO_FUNC(element_info)(libpalo_err *err, struct arg_dim_element_info2 *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *dimension, const CHAR_T *element) {
	return LIBPALO_FUNC_R(element_info)(err, result, so, &libpalo_convs, database, dimension, element);
}
...
LIBEXPORT libpalo_result LIBPALO_FUNC(is_admin_user)(libpalo_err *err, unsigned short int *retresult, struct sock_obj *so) {
	...
	return _to_libpalo_result(PALO_SUFFIX(is_admin_user)(errs, retresult, so, &libpalo_convs), err, errs, __FUNCTION__, __FILE__, __LINE__);
}
...
LIBEXPORT libpalo_result LIBPALO_FUNC(rule_add)(libpalo_err *err, struct arg_rule_info *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *cube, const CHAR_T *definition, unsigned short use_identifier, const CHAR_T *extern_id, const CHAR_T *comment, unsigned short activate) {
	return LIBPALO_FUNC_R(rule_add)(err, result, so, &libpalo_convs, database, cube, definition, use_identifier, extern_id, comment, activate);
}


/** @brief see thread-safe rule_modify() */
LIBEXPORT libpalo_result LIBPALO_FUNC(rule_modify)(libpalo_err *err, struct arg_rule_info *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *cube, long id, const CHAR_T *definition, unsigned short use_identifier, const CHAR_T *extern_id, const CHAR_T *comment, unsigned short activate) {
	return LIBPALO_FUNC_R(rule_modify)(err, result, so, &libpalo_convs, database, cube, id, definition, use_identifier, extern_id, comment, activate);
}
...
LIBEXPORT libpalo_result LIBPALO_FUNC(cube_lock)(libpalo_err *err, struct arg_lock_info *result, struct sock_obj *so, const CHAR_T *database, const CHAR_T *cube,  const struct arg_str_array_array coordinates) {
	return LIBPALO_FUNC_R(cube_lock)(err, result, so, &libpalo_convs, database, cube, coordinates);
}
