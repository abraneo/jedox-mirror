...
struct arg_parent_info_w {
	long identifier;
	wchar_t *name;
	de_type type;
};

struct arg_parent_info_m {
	long identifier;
	char *name;
	de_type type;
};

struct arg_parent_info_a {
	long identifier;
	char *name;
	de_type type;
};

struct arg_child_info_w {
	long identifier;
	wchar_t *name;
	double factor;
	de_type type;
...
struct arg_dim_element_info2_w {
	long identifier;
	wchar_t *name;
	de_type type;
	...
	struct arg_parent_info_w * parents;
	struct arg_child_info_w * children;
};

struct arg_dim_element_info2_m {
	long identifier;
	char *name;
	de_type type;
	unsigned long level;
	...
	struct arg_parent_info_m * parents;
	struct arg_child_info_m * children;
};

struct arg_dim_element_info2_a {
	long identifier;
	char *name;
	de_type type;
	unsigned long level;
	...
	struct arg_parent_info_a * parents;
	struct arg_child_info_a * children;
};

struct arg_dim_element_info2_array_w {

	size_t len;
	struct arg_dim_element_info2_w *a;
};

struct arg_dim_element_info2_array_m {
	size_t len;
	struct arg_dim_element_info2_m *a;
};

struct arg_dim_element_info2_array_a {
	size_t len;
	struct arg_dim_element_info2_a *a;
};
...
extern "C" {
	...
	void free_arg_dim_element_info2_contents_w(struct arg_dim_element_info2_w *dei);
	void free_arg_dim_element_info2_array_contents_w(struct arg_dim_element_info2_array_w *deia);
	...
	void free_arg_dim_element_info2_contents_m(struct arg_dim_element_info2_m *dei);
	void free_arg_dim_element_info2_array_contents_m(struct arg_dim_element_info2_array_m *deia);
	...
	void free_arg_dim_element_info2_contents_a(struct arg_dim_element_info2_a *dei);
	void free_arg_dim_element_info2_array_contents_a(struct arg_dim_element_info2_array_a *deia);
