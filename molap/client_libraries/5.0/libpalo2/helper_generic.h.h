...
palo_err PALO_SUFFIX(dimension_list_elements2)(struct errstack *errs, struct arg_dim_element_info2_array *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *dimension);
...
palo_err PALO_SUFFIX(_getdata_multi)(struct errstack *errs, struct arg_palo_value_array *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_2d *coordinates);
...
palo_err PALO_SUFFIX(getdata_export)(struct errstack *errs, struct arg_getdata_export_result *result, struct sock_obj *so, struct conversions *convs, const CHAR_T *database, const CHAR_T *cube, const struct arg_str_array_array *elements, struct arg_getdata_export_options *options);
