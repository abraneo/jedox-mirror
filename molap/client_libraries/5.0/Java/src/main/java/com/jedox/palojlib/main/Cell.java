...
public class Cell implements ICell {
	...
	public Cell(String[] pathstr, Object value, CellType type, IDimension[] dimensions) {
	
		this.path = new int[pathstr.length];
		
		for(int j=0;j<pathstr.length;j++){
			this.path[j] = Integer.parseInt(pathstr[j]);
		}
	...
	public Cell(int[] path, Object value, CellType type, IDimension[] dimensions) {
