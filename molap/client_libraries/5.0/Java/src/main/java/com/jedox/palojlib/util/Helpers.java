...
public final class Helpers {
	...
	/*public static String buildConnectionId(String host, String port, String username, String password,int timeout, boolean sslPreferred,){
		return (host + " - " + port + " - " + username + " - " + password + " - " + timeout + " - " + sslPreferred);
	}*/
	...
	public static String escapeDoubleQuotes(String value){
		return value.replaceAll("\"", "\"\"");//double quotation
	}
	...
	//boolean addDoubleQuotes,boolean escapeDoubleQuotes
