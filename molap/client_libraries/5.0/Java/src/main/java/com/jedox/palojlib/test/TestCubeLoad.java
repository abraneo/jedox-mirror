...
public class TestCubeLoad {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ICube d = demo.getCubeByName("Sales");
			int ii = d.lockComplete();
			System.out.println("the cube is locked!!");
			d.commitLock(ii);
			...
			demo.getCubeByName("Sales").loadCells(paths, values, new CellLoadContext(SplashMode.SPLASH_DEFAULT, 3, false, true));
