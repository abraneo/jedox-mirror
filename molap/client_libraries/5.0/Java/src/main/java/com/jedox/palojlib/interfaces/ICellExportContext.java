...
public interface ICellExportContext {
	...
	/**
	 * type of the export {@link CellsExportType}.
	 * @return type
	 */
	public CellsExportType getCellsExportType();

	/**
	 * maximum number of cells returned for each server call.
	 * @return blocksize
	 */
	 ...
	 * true means numeric/string base cells and string consolidated cells, (everything in olap csv files).
	 * @return onlyBases
	 */
	 ...
	 * true means empty cells are not exported e.g. zero for numeric and "" for string cells.
	 * @return skipEmpty
	 */
