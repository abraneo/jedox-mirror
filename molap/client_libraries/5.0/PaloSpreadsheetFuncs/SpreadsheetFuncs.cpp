...
void SpreadsheetFuncs::FPaloDimensionInfo(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg)
{
	...
	arg.fixConnection(0);
	arg.checkArgCount(3);
	retval.set(SpreadsheetFuncsBase::FPaloDimensionInfo(arg[0].getConnection(), arg[1].getString(), arg[2].getString()));
}
...
void SpreadsheetFuncs::FPaloCubeInfo(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg)
{
	...
	arg.checkArgCount(3);
	// void	
	retval.set(SpreadsheetFuncsBase::FPaloCubeInfo(arg[0].getConnection(), arg[1].getString(), arg[2].getString()));
}
...
void SpreadsheetFuncs::FPaloGetdataA(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg)
{
	...
	if (arg[3].empty(false)) {
		...
		retval.set(SpreadsheetFuncsBase::FPaloGetdata(arg[0].getConnection(), arg[1].getString(), arg[2].getString(), arg[3].getStringArray()));
	}
}
...
void SpreadsheetFuncs::FPaloGetdataAT(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg)
{
	...
	if (arg[3].empty(false)) {
		...
		GetdataHelper::_GetdataT(retval, SpreadsheetFuncsBase::FPaloGetdata(arg[0].getConnection(), arg[1].getString(), arg[2].getString(), arg[3].getStringArray()));
	}
}
...
void SpreadsheetFuncs::FPaloGetdataAggregation(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg, AggregationType aggregationtype)
{
	...
	arg.fixConnection(0);
	arg.checkArgCount(5);
	retval.set(SpreadsheetFuncsBase::FPaloGetdataAggregation(arg[0].getConnection(), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), aggregationtype, arg[4].getIntArray()));
}
...
SubsetResults SpreadsheetFuncs::FPaloSubset(GenericContext& opts, GenericArgumentArray& arg)
{
	...
	return SpreadsheetFuncsBase::FPaloSubset(arg[0].getConnection(), arg[1].getString(), arg[2].getString(), arg[3].isMissing() ? 1 : arg[3].getSInt(), basic, text, sorting, alias, field, structural, data);
}
...
{
	return SpreadsheetFuncsBase::FPaloGetdataC(server.getConnection(), database.getString(), cube.getString(), path.getStringArray(), ptr);
}
