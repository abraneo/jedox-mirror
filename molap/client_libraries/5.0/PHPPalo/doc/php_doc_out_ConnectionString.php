...
/**
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_version.php}
  *				
  *
 */
...
/**
  ...
  * 
  *Example:  
  * {@example ./example/ConnectionString/palo_error.php}
  *				
  *
 */
	function palo_error(){
...
/**
  ...
  *
  * palo_register_server("test", ...) allows you to do things like palo_database_list_cubes("test/MyDatabase") instead of using resources
  *
  * @param string Name for the connection
  * @param string Address or hostname of the Palo server
  * @param int Port to which the server listens
  * @param string User who should connect to the Palo server
  * @param string Password of the user
  * @return mixed Connection id or error
  *
  *Example:
  * {@example ./example/ConnectionString/palo_register_server.php}   
 */
	function palo_register_server($connection, $host, $username, $password){
		return $res;
	}
...
/**
  ...
  *
  *Example:
  * {@example ./example/ConnectionString/palo_server_info.php}    
  *      
 */
	function palo_server_info($connection){
		return $res;
	}
...
/**
  ...
  * {@example ./example/ConnectionString/palo_cube_clear.php}
  *   
  * 
*/
	function palo_cube_clear($connection, $cube_name, $element_list){
		return $res;
	}
 ...
 /**
    ...
    * 
    *Example:
    * {@example ./example/ConnectionString/palo_dimension_clear.php}
    *		    
  */

  function palo_dimension_clear($connection, $dimension){
    return $res;
  }
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_root_add_database.php}
*/
	function palo_root_add_database($connection, $type){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_root_delete_database.php}
*/
	function palo_root_delete_database($connection){
		return $res;
	}
...
/**
  ...
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_database_add_cube.php}  
*/
	function palo_database_add_cube($connection, $cube_name, $cube_data){
		return $res;
	}

/**
  * Deletes a cube from to the specified database.
  *
  * @param string "connection_name/database_name"
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_database_delete_cube.php} 
*/
	function palo_database_delete_cube($connection, $cube_name){
		return $res;
	}
...
/**
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_database_load_cube.php}
  *            
*/
	function palo_database_load_cube($connection, $cube_name){
		return $res;
	}
...
/**
  ...
  *
  *Example:
  * {@example ./example/ConnectionString/palo_database_unload_cube.php}
*/
	function palo_database_unload_cube($connection, $cube_name){
		return $res;
	}

/**
  * Adds a dimension to to the specified database.
  *
  * @param string "connection_name/database_name"
  ...
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_database_add_dimension.php}
*/
	function palo_database_add_dimension($connection, $dimension_name){
		return $res;
	}

/**
  * Delets a dimension from to the specified database.
  *
  * @param string "connection_name/database_name"
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_database_delete_dimension.php}
*/
	function palo_database_delete_dimension($connection, $dim_name){
		return $res;
	}

/**
  * Returns the list of all children for the specified element (alias of palo_element_list_children)
  *
  * @param string "connection/database_name"
  * @param string Name of the dimension
  * @param string Name of the element to be searched
  * @return array List of associative arrays ("name", "type", "id", "factor") or error.
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_element_list_consolidation_elements.php}
  *      
*/
	function palo_element_list_consolidation_elements($connection, $dimension_name, $element_name){
		return $res;
	}
...
/**
  ...
  *
  *Example for the code:
  * {@example ./example/ConnectionString/palo_dimension_list_elements2.php}
*/
	function palo_dimension_list_elements2($connection, $dimension_name, $filter){
		return $res;
	}
...
/**
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_dimension_list_elements.php}
  *      
*/
	function palo_dimension_list_elements($connection, $dimension_name, $filter){
		return $res;
	}
...
/**
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_dimension_list_cubes.php}
*/
	function palo_dimension_list_cubes($connection, $dimension_name){
		return $res;
	}
...
/**
  ...
  *
  * Example:
  * {@example ./example/ConnectionString/palo_cube_list_dimensions.php} 
*/
	function palo_cube_list_dimensions($connection, $cube_name){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_database_list_cubes.php}  
  *
  *        
*/
	function palo_database_list_cubes($connection, $cube_type){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_database_list_dimensions.php}  
  *          
*/
	function palo_database_list_dimensions($connection, $dimension_type){
		return $res;
	}
...
/**
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_root_list_databases.php} 
*/
	function palo_root_list_databases($connection, $show_system, $show_userinfo){
		return $res;
	}
...
/**
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_database_rename_dimension.php}              
*/
	function palo_database_rename_dimension($connection, $dimension_name, $new_dimension_name){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eadd.php} 
*/
	function palo_eadd($connection, $dimension_name, $element_type, $element_name, $parent_element_name, $consolidation_factor, $clear, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_edelete.php}  
  *
  *        
*/
	function palo_edelete($connection, $dimension, $element, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_edelete_bulk.php}  
  *
  *        
*/
	function palo_edelete_bulk($connection, $dimension, $elements, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_emove.php}   
*/
	function palo_emove($connection, $dimension_name, $element_name, $new_position){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_erename.php}            
*/
	function palo_erename($connection, $dimension_name, $element_name, $new_element_name, $emtpy_string){
		return $res;
	}
...
/**
  ...
  *  
  * Example: 
  * {@example ./example/ConnectionString/palo_eupdate.php}     
  *    
*/
	function palo_eupdate($connection, $dimension_name, $element_name, $element_type, $consolidated_elements, $mode){
		return $res;
	}
...
/**
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_echildcount.php} 
  *        
*/
	function palo_echildcount($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  *
  * @param resource connection/database_name
  * @param string Name of the dimension which contains the element
  * @param string Name of the element
  ...
  *   
  * Example:
  * {@example ./example/ConnectionString/palo_echildname.php}
*/
	function palo_echildname($connection, $dimension_name, $element_name, $child_number, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_ecount.php}
*/
	function palo_ecount($connection, $dimension_name, $emtpy_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_efirst.php}
  *
  *      
*/
	function palo_efirst($connection, $dimension_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eindex.php}
  *      
*/
	function palo_eindex($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eischild.php}         
*/
	function palo_eischild($connection, $dimension_name, $parent_element, $element, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_elevel.php}
*/
	function palo_elevel($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eindent.php}
  *       
*/
	function palo_eindent($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  *
  *Example:
  * {@example ./example/ConnectionString/palo_ename.php}
  *      
*/
	function palo_ename($connection, $dimension_name, $position){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eparentcount.php} 
  *      
*/
	function palo_eparentcount($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eparentname.php}  
*/
	function palo_eparentname($connection, $dimension_name, $element_name, $parent_number, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_eprev.php} 
*/
	function palo_eprev($connection, $dimension_name, $element_name, $emtpy_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_enext.php}
  *      
*/
	function palo_enext($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_esibling.php}
  *          
*/
	function palo_esibling($connection, $dimension_name, $element_name, $sibling_number, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_etoplevel.php}   
*/
	function palo_etoplevel($connection, $dimension_name){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_etype.php}    
*/
	function palo_etype($connection, $dimension_name, $element_name, $empty_string){
		return $res;
	}
...
/**
  ...
  * 
  *Example: 
  * {@example ./example/ConnectionString/palo_eweight.php} 
*/	
	function palo_eweight($connection, $dimension_name, $consolidation_element, $child_element, $emtpy_string){
		return $res;
	}
...
/**
  * Returns the data at the specified coordinates or error if the data could not be fetched (DEPRECATED).
  * Use palo_dataa instead
  *
  *
  * @param string "connection_name/database_name"
  * @param string Name of the cube to be queried
  ...
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_getdata.php}
 */
	function palo_getdata($connection, $cube_name, $coordinates){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_dataa.php}         
 */
	function palo_dataa($connection, $cube_name, $coordinates){
		return $res;
	}
...
/**
  ...
  * 
  *Example:
  * {@example ./example/ConnectionString/palo_dataat.php} 
  *                   
 */
	function palo_dataat($connection, $cube_name, $coordinates){
		return $res;
	}
...
/**
  ...
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_dataac.php} 
  *
  *                    
 */
	function palo_dataac($connection, $cube_name, $coordinates){
		return $res;
	}
...
/**
  ...
  * 
  * Example:     
  * {@example ./example/ConnectionString/palo_dataatc.php} 
  *            
 */
	function palo_dataatc($connection, $cube_name, $coordinates){
		return $res;
	}
...
/**
  ...
  *   
  * Example:     
  * {@example ./example/ConnectionString/palo_data.php} 
  *                            
 */
	function palo_data($connection, $cube_name, $coordinate1){
		return $res;
	}
...
/**
  ...
  * 
  *Example:     
  * {@example ./example/ConnectionString/palo_datat.php} 
  *     
 */
	function palo_datat($connection, $cube_name, $coordinate1){
		return $res;
	}
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_datac.php}
  *          
 */
	function palo_datac($connection, $cube_name, $coordinate1){
		return $res;
	}
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_datatc.php}
 */
	function palo_datatc($connection, $cube_name, $coordinate1){
		return $res;
	}
...
/**
  ...
  *    
  *Example:     
  * {@example ./example/ConnectionString/palo_setdataa.php}
  *    
  *      
 */
	function palo_setdataa($value, $splash, $connection, $cube_name, $dimensions){
		return $res;
	}
...
/**
  ...
  *
  *Example:     
  * {@example ./example/ConnectionString/palo_setdata.php}
  *
  *<ul>
  ...
  *      
 */
	function palo_setdata($value, $splash, $connection, $cube_name, $dimensions, $coordinate1){
		return $res;
	}
...
/**
  ...
  * 
  *Example for the code:    
  * {@example ./example/ConnectionString/palo_getdata_export.php}
  *
*/
  function palo_getdata_export($connection, $cube_name, $ignore_empty, $base_only, $lower_limit, $upper_limit, $lower_operator, $upper_operator, $compare_mode, $max_rows, $first_path, $subcube, $use_rules){
    return $res;
  }
...
/**
  ...
  *
  * Example:
  * {@example ./example/ConnectionString/palo_datav.php}
  *   
 */
	function palo_datav($connection, $cube_name, $coordinate1){
		return $res;
	}
...
/**
  ...
  *  
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_rule_create.php}                       
 */
 
 	function palo_cube_rule_create($connection, $cube_name, $definition){
		return $res;
	}
...
/**
  ...
  *          
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_rule_parse.php}                       
 */
 
 	function palo_cube_rule_parse($connection, $cube_name, $definition){
		return $res;
	}
...
/**
  ...
  *  
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_rules.php}                       
 */
 
 	function palo_cube_rules($connection, $cube_name){
		return $res;
	}
  ...
  *  
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_rule_delete.php}                       
 */
 
 	function palo_cube_rule_delete($connection, $cube_name, $rule){
		return $res;
	}
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_setdata_bulk.php}                       
 */
 
 	function palo_setdata_bulk($connection, $cube_name, $coordinates, $value, $splash){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_ping.php}                       
 */
 
 	function palo_ping($connection);
...
/**
  * Returns the list of all children for the specified element (alias of palo_element_list_consolidation_elements)
  *
  * @param string "connection/database_name"
  * @param string Name of the dimension
  * @param string Name of the element to be searched
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_element_list_children.php}                       
 */
 
 	function palo_element_list_children($connection, $dimension_name, $element_name){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_subset.php}                       
 */
 
 	function palo_subset($connection, $dimension, $indent, $alias, $filter){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_element_create_bulk.php}                       
 */
 
 	function palo_element_create_bulk($connection, $dimension, $element, $type, $children, $weight){
...
/**
  ...
  *
  * Example:  
  * {@example ./example/ConnectionString/palo_dfilter.php}                       
 */
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_rule_modify.php}                       
 */

 	function palo_cube_rule_modify($connection, $cube, $identifier, $new_definition, $extern_id, $comment, $active){
...
/**
  ...
  *
  * @param string string name of the host/name of the database
  * @param string name of the dimension
  * @param int Entry of 1 or 2 or 3 controls the kind of indent. If empty the view is flat
  * @param string Alternative name for an element that defined as an attribute (optional)
  * @param array Result of DFILTER, AFILTER, PICKLIST, HFILTER, TFILTER or SORT in order as how mentioned (optional)
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_subset_size.php}                       
 */

 	function palo_subset_size($connection, $element, $indent, $alias, $filter){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_picklist.php}                       
 */
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_tfilter.php}                       
 */
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_sort.php}                       
 */
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_cube_info.php}                       
 */

	function palo_cube_info($connection, $cube){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_dimension_info.php}
  *
  *  
  ...
  */
	...
	function palo_dimension_info($connection, $dimension){
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_hfilter.php}                       
 */
...
/**
  ...
  *
  * Example:     
  * {@example ./example/ConnectionString/palo_afilter.php}                       
 */
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_cube_id.php}   

 */

	function palo_get_cube_id($connection, $cube_name){
		return $res;
	}
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_cube_name.php}   
 */

	function palo_get_cube_name($connection, $cube_id){
		return $res;
	}
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_dimension_name.php}   
 */

	function palo_get_dimension_name($connection, $dimension_id){
		return $res;
	}
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_dimension_id.php}   
 */

	function palo_get_dimension_id($connection, $dimension_name){
		return $res;
	}
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_element_id.php}   
 */

	function palo_get_element_id($connection, $dimension_name, $element_name){
		return $res;
	}
...
/**
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_get_element_name.php}   
 */

	function palo_get_element_name($connection, $dimension_name, $element_id){
		return $res;
	}
  ...
  *              
  * Example:     
  * {@example ./example/ConnectionString/palo_license_info.php}   
 */

	function palo_license_info($connection){
		return $res;
		}
  ...
  *                   
  * Example:     
  * {@example ./example/ConnectionString/palo_use_unicode.php}   
 */
  ...
  *
  * Example:
  * {@example ./example/ConnectionString/palo_dataav.php}
  *   
  */
	function palo_dataav($connection, $cube_name, $coordinate1){
		return $res;
	}	
	/**
  * Changes password.
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_change_password.php}              
  */
	function palo_change_password($connectionstring, $oldpassword, $newpassword){
		return $res;
	}
		/**
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_goal_seek.php}              
  */
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_cellcopy.php}              
  */
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_get_user_for_sid.php}              
  */
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_change_user_password.php}              
  */
	function palo_change_user_password($connection, $username, $password){
		return $res;
	}
	/**
  ...
  * 
  * Example:
  * {@example ./example/ConnectionString/palo_set_client_description.php}              
  */
