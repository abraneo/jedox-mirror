<?php
	...
	palo_etype($connection_id, $db_name, $dimension_name, $element_name);

	// returns the type of element Server Dual C		
	palo_etype($connection_id, $db_name, $dimension_name, $element_name, true);

	// the empty string parameter hides the error, if set to true		
	palo_etype($connection_id, $db_name, $dimension_name, 
