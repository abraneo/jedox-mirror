<?php
	...
	palo_eparentname($connection_id, $db_name, $dimension_name, $element_name, 1); 

	// retrieves the name of the 1st parent of the element 'Server Dual C'
	palo_eparentname($connection_id, $db_name, $dimension_name, $element_name, 1, true);
	
	// the empty string parameter hides the error, if set to true
	palo_eparentname($connection_id, $db_name, $dimension_name, 
