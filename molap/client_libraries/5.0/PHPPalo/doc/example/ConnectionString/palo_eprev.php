<?php
	...
	palo_eprev(CONN . '/' . $db_name, $dimension_name, $element_name);

	// retrieves the previous element of element 2004
	palo_eprev(CONN . '/' . $db_name, $dimension_name, $element_name, true);

	// the empty string parameter hides the error, if set to true
	palo_eprev(CONN . '/' . $db_name, $dimension_name_test_empty_string,
	                 $element_name, true);
