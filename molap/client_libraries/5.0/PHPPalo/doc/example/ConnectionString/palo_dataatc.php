<?php
	...
	$dimension1 = array('Desktop L','Germany','Jan','2002','Budget','Units');
	
	$dimension2 = array('Desktop L','Germany','Jan','2002','Budget','Gross Profit');   			
	...
	palo_dataatc(CONN . '/' . $db_name, $cube_name, $dimension1);
	palo_dataatc(CONN . '/' . $db_name, $cube_name, $dimension2);
