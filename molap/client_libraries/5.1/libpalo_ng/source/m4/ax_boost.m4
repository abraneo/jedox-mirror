...
AC_DEFUN([BOOST_STATIC],
  [AC_ARG_ENABLE([static-boost],
     [AC_HELP_STRING([--disable-static-boost],
               [Prefer the shared boost libraries over the static ones [no]])],
     [enable_static_boost=no],
     [enable_static_boost=yes])])# BOOST_STATIC
...
LIBS="$LIBS $boost_cv_pthread_flag $BOOST_SYSTEM_LIBS"
