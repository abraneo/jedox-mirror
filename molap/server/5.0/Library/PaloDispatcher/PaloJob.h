...
protected:
	...
	void generateDatabasesResponse(CPServer server, vector<CPDatabase>* databases, bool showNormal, bool showSystem, bool showUserInfo);
	...
	void generateElementResponse(CPDimension dimension, Element* element);
	void generateElementsResponse(CPDimension dimension, ElementsType* elements);
	void generateElementsValuesResponse(CPDimension dimension, list<Element*> *elements, IdentifiersType &elementIds, vector<CellValue> *vals);
	void generateElementLockResponse(CPDimension dimension, Element *element);
...
private:
	...
	void appendDimension(StringBuffer* sb, CPDimension dimension);
	void appendElement(StringBuffer* sb, CPDimension dimension, Element* element, IdentifierType elemId=0);
