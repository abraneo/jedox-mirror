...
//			ptime parsingStart(microsec_clock::local_time());
			...
			PCellValueContext cvc = PCellValueContext(new CellValueContext(cube, CellValueContext::CELL_REPLACE_BULK_JOB, database, user, session, checkArea, jobRequest->add/*addFlag*/, mode, lockedPaths, PCubeArea(), unused, NULL));
