...
public:
	...
	virtual void appendEscapeString(const string& value) = 0;
	...
	virtual void appendIdentifier(const IdentifierType value) = 0;
	...
	virtual void appendDouble(const double value) = 0;
