...
public:
	CubeFileStream(PDatabase db, PCube cube, FileReader *file, bool isString, map<IdentifierType, IdentifierType> *groupMap);
...
private:
	...
	bool first;
	map<IdentifierType, IdentifierType> *groupMap;
	bool anyReMap;
