...
class SimpleCache {
public:
	typedef std::pair<double, uint8_t> cache_value_type; //value, isString
...
SimpleCache::cache_value_type &operator+=(SimpleCache::cache_value_type &cv, const SimpleCache::cache_value_type &acv);
