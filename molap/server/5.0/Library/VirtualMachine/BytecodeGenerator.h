...
public:
	...
	enum WM_OPCODES {
		...
		FUNC_ISERROR_DBL = 220, FUNC_ISERROR_STR = 221,
...
private:
	void GrowDblStackCode();
	void ShrinkDblStackCode();
	void GrowStrStackCode();
	void ShrinkStrStackCode();
	size_t ifLevel;
public:
