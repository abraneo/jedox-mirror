...
class SERVER_CLASS LicenseInfoProcessor : public CellValueStream {
public:
	LicenseInfoProcessor(CPArea filter, PLicIter licIter) : filter(filter), i(0), licIter(licIter), licCont(false) {}
...
public:
	...
	virtual void checkPathAccessRight(PDatabase db, PUser user, PCubeArea cellPath, bool isZero, RightsType minimumRight) const;
