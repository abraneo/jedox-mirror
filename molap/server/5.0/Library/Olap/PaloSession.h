...
public:
	...
	static boost::shared_ptr<PaloSession> createSession(string sid, IdentifierType sidId, PUser user, bool worker, time_t ttl, bool testSession, const string peerName, const string *machine, const string *required, string *optional, const string description);

	////////////////////////////////////////////////////////////////////////////////
	/// @brief creates a new session
	////////////////////////////////////////////////////////////////////////////////

	static boost::shared_ptr<PaloSession> createSession(PUser user, bool worker, time_t ttl, bool shortSid, bool testSession, const string peerName, const string *machine, const string *required, string *optional, const string description);
...
private:
	...
	PaloSession(string sid, IdentifierType id, PUser user, bool worker, time_t, const string peerName, const string description, const string &machineId);
...
private:
	...
	struct JOB_INFO {
		...
		JOB_INFO(string username, time_t starttime, double duration, string request) :
			username(username), starttime(starttime), duration(duration), request(request) {}
	};
