...
public:
	...
	RuleMarker(dbID_cubeID allDbCube, const Area* fromArea, const Area* toArea);

	RuleMarker(dbID_cubeID fromDbCube, dbID_cubeID toDbCube, const vector<Node *>& path, const Area* toArea);
