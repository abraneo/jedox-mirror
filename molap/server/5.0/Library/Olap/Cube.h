...
public:
	...
	vector<PRule> getRules(PUser) const;
...
public:
	...
	virtual PRule createRule(PServer server, PDatabase db, PRuleNode, const string& definition, const string& external, const string& comment, bool activate, PUser, bool useJournal, IdentifierType *id);

	////////////////////////////////////////////////////////////////////////////////
	/// @brief modifies an existing rule
	////////////////////////////////////////////////////////////////////////////////

	virtual bool modifyRule(PServer server, PDatabase db, PRule, PRuleNode, const string& definition, const string& external, const string& comment, PUser, ActivationType activation, bool useJournal);
	...
	virtual bool deleteElement(PServer server, PDatabase db, PUser user, const string& event, CPDimension dimension, IdentifierType element, bool deleteRules, CubeRulesArray* disabledRules, Dimension::DeleteCellType delType, bool completeRemove);
	virtual bool deleteElements(PServer server, PDatabase db, PUser user, const string& event, CPDimension dimension, IdentifiersType elements, bool deleteRules, CubeRulesArray* disabledRules, Dimension::DeleteCellType delType, PSet fullSet, bool completeRemove);
...
public:
	...
	virtual ResultStatus setCellValue(bool isBulk);
	...
	virtual CellValue getCellValue(PCubeArea cellPath) const;
	...
	void copyCellCreateMaps(PDatabase db, Element *sourceElem, Element *targetElem, CPDimension dim, PSetMultimap &setMultimap, IdentifierType &targetTransformId,
	...
	virtual PCellStream evaluatePlan(PPlanNode plan, EngineBase::Type engineType) const;
...
public:
	...
	virtual RightsType getMinimumAccessRight(PUser user) const;

	////////////////////////////////////////////////////////////////////////////////
	/// @brief checks the cube access right
	////////////////////////////////////////////////////////////////////////////////

	virtual void checkCubeAccessRight(PUser user, RightsType minimumRight) const;

	////////////////////////////////////////////////////////////////////////////////
	/// @brief get the minimum access right for the cube
	////////////////////////////////////////////////////////////////////////////////

	virtual RightsType getElementAccessRight(CPDatabase db, PUser user, CPDimension dim, IdentifierType elemId, vector<User::RoleCubeRight>& rcRights) const;
...
protected:
	...
	bool loadCubeCells(FileReader *fr, PDatabase db, bool loadGroups, bool binary, bool &diffGroup, uint32_t fileversion);
	...
	void saveCubeCells(FileWriter *file, PServer server, PDatabase db, bool saveGroups, bool binary);

	void saveCubeRule(FileWriter* file, CPRule rule, CPDatabase db);

	void saveCubeRules(CPDatabase db);

	void loadCubeIntern(PServer server, PDatabase db, bool processJournal, bool saveCells, bool checkGroup);
	void saveCubeIntern(PServer server, PDatabase db, bool saveCells, bool checkGroup);
...
private:
	...
	void loadFromFile(PServer server, PDatabase db, bool loadCells, bool loadGroups, bool binary);
	void saveToFile(PServer server, PDatabase db, bool saveCells, bool saveGroups, timeval &tv, bool binary);
