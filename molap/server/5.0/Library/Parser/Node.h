...
public:
	enum ValueType {
		NODE_UNKNOWN_VALUE, NODE_NUMERIC, NODE_STRING, NODE_STET, // ignore rule for cell
		NODE_CONTINUE
		// use next rule for cell
	};

	enum NodeType {
		NODE_FUNCTION_PALO_MARKER, NODE_DOUBLE_NODE, NODE_FUNCTION_DIV, NODE_FUNCTION_IF, NODE_FUNCTION_MULT, NODE_FUNCTION_STET, NODE_SOURCE_NODE, NODE_STRING_NODE, NODE_UNKNOWN, NODE_VARIABLE_NODE, NODE_FUNCTION_ADD, NODE_FUNCTION_SUB
	};
...
public:
	...
	virtual bool isConstant(CPCube) {
		return false;
	}
