...
public:
	...
	static int compare(const std::string &s1, const std::string &s2) {return compare(s1.c_str(), s2.c_str());}
...
public:
	...
	static void splitString2(char* ss, char* se, vector<vector<string> >* elements, char separator1, char separator2, bool quote);
};
