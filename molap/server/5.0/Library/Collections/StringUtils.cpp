...
int UTF8Comparer::compare(const char *s1, const char *s2)
{
	UTF8ComparerInternal *u8 = utf8impl.get();
	if (!u8) {
		u8 = new UTF8ComparerInternal();
	...
	return u8->col->compareUTF8(s1, s2, st);
}
...
void StringUtils::splitString2(char* ss, char* se, vector<vector<string> >* elements, char separator1, char separator2, bool quote)
{
