...
enum RightsType {
	RIGHT_NONE, RIGHT_READ, RIGHT_WRITE, RIGHT_DELETE, RIGHT_SPLASH
};
...
enum RulesType {
	NO_RULES = 0, DIRECT_RULES = 1, INDIRECT_RULES = 2, ALL_RULES = 3, NOCACHE = 4
};
...
enum PlanNodeType {
	COMBINATION, SEQUENCE, SOURCE, AGGREGATION, ADDITION, SUBTRACTION, MULTIPLICATION, DIVISION, LEGACY_RULE, TRANSFORMATION, CACHE, QUERY_CACHE, CONSTANT, CELLMAP, CELL_RIGHTS
};
