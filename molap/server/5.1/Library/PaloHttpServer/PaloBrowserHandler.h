...
#ifndef PALO_HTTP_SERVER_PALO_BROWSER_HANDLER_H
#define PALO_HTTP_SERVER_PALO_BROWSER_HANDLER_H 1
...
class SERVER_CLASS PaloBrowserHandler : public PaloRequestHandler {
public:
	...
	PaloBrowserHandler(const string& browserPath) :
