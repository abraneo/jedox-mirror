...
#ifndef PALO_BROWSER_SESSION_BROWSER_JOB_H
#define PALO_BROWSER_SESSION_BROWSER_JOB_H 1
...
class SERVER_CLASS SessionBrowserJob : public PaloBrowserJob {
public:
...
public:
	...
	SessionBrowserJob(PaloJobRequest *jobRequest) :
