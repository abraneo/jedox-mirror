...
public interface IProcessor {
	...
	/**
	 * Gets the name of the origin of the data
	 * @return the name of the processor.
	 */
	public String getOrigin();
	
	/**
	 * Sets the name of the processor, which by default should be the name of the underlying source.
	 * @param name the name of the processor.
	 */
	public void setName(String name);
	
	/** 
	 * Sets an external execution state for this processor. Processor aborts processing if the state changes to non-executable.
	 * @param state
	 */
	...
	/**
	 * Adds a filter to this processor.
	 * @param filter the filter defining certain criteria of accepting or rejecting the row based on its data.
	 */
	public void addFilter(RowFilter filter);
	/**
	 * Removes all filters from this processor.
	 */
	...
	public void close();
	/**
	 * Activates the output of Info Messages with a specific display name for the processor
	 * @param info activate the output of info messages
	 * @param displayType text used in info messages for the underlying component type of the processor 
	 */
	public void setInfo(boolean info, String displayType);
	/**
	 * Gets all the results of this processor at once in a matrix format holding all rows and columns.
	 * @return the result matrix.
	 */
	public String[][] getResultMatrix() throws RuntimeException;
	/**
	 * Sets the encoding for all character based results of this Processor
	 * @param sourceEncoding the encoding the source data is in.
	 * @param targetEncoding the encoding the resulting data should be converted to.
	 */
