...
public class SSLUtil {
	...
	public SSLUtil() throws RuntimeException{
		try {
	...
	public void addCertToKeyStore(URL url) throws Exception {
	...
	public static boolean supportsSSL (String urlString) {
		try {
			URL url = new URL(urlString);
			String protocol = url.getProtocol();
			return protocol.equalsIgnoreCase("https")||protocol.equalsIgnoreCase("ftps");							
		}
