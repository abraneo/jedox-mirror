...
public class CubeSliceExtractConfigurator extends CubeExtractConfigurator {
	...
	NO_FILTER_MODE mode=NO_FILTER_MODE.exclude;
	...
	public void configure() throws ConfigurationException {
		...
		if (query != null){
			boolean generateRoots = Boolean.parseBoolean(query.getAttributeValue("generateRoots","false"));
			boolean generateBases = Boolean.parseBoolean(query.getAttributeValue("generateBases","false"));
			if (generateRoots && generateBases)
				throw new ConfigurationException("Options generateRoots and generateBases cannot be set together.");
			if (generateRoots)
				mode = NO_FILTER_MODE.generateRoots;
			if (generateBases)
				mode = NO_FILTER_MODE.generateBases;
