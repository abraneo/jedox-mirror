			...
			try {
				...
				for (int i=0; i<processor.current().size(); i++) {
					...
					if (mode != null) {
						...
						switch (mode) {
						case sum: definition.setType(c.getName(), Double.class.getCanonicalName()); break;
						case avg: definition.setType(c.getName(), Double.class.getCanonicalName()); break;
						case count: definition.setType(c.getName(), Double.class.getCanonicalName()); break;
						default:
						}
					}
					else {
