...
public class CubeWrapper implements ICube {
	...
	public BigInteger getNumberOfCells() throws PaloException {
		throw new PaloJException("Getting number of cells is not supported by OLAP4j provider.");
	}

	@Override
	public BigInteger getNumberOfFilledCells() throws PaloException {
		throw new PaloJException("Getting number of filled cells is not supported by OLAP4j provider.");
	}
...
//			if (!wrapper.getDimension().equals(cube.getDimensions().get(i))) { 
	...
	public IRule[] getRules() {
		throw new PaloJException("Getting rules is not supported by OLAP4j provider.");
	}
	...
	@Override
	public void loadCells(IElement[][] paths, Object[] values, ICellLoadContext context, IElement[][] lockedpaths) throws PaloException {
		throw new PaloJException("Loading cells not implemented yet.");
	...
	public String parseRule(String arg0) throws PaloException, PaloJException {
		throw new PaloJException("parseRules is not supported by OLAP4j provider.");	
	}

	@Override
	public IElement[] getCellPath(String[] arg0) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ICellLoadContext getCellLoadContext(SplashMode arg0, int arg1,
